...
function init() {
  ...
  const boxObj = sheet.object('Box', {
	...
	scale: types.compound({
	  x: types.number(1, { range: [0.1, 5], step: 0.1 }), // Default scale 1, adjustable from 0.1 to 5
	  y: types.number(1, { range: [0.1, 5], step: 0.1 }),
	  z: types.number(1, { range: [0.1, 5], step: 0.1 })
	})
  });
